      ...
      <Dialog as="div" className="relative z-10" onClose={handleStateChange}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative px-4 pt-5 pb-4 overflow-hidden text-left transition-all transform border rounded-lg shadow-xl bg-firefly border-white/10 sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div className="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
                  <button
                    type="button"
                    className="text-white rounded-md bg-firefly hover:text-white/75 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ring-offset-firefly"
